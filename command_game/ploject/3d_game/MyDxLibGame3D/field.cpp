	...
	if (player->menu_open_flag)
	{
		...
		for (int i = 0; i < 3; i++)
		{
			...
			if (player->c_ally[i].hp >= player->c_ally[i].max_hp * 0.3)
			{
				...
				comment->Draw((float)(menu_pos[1].x + 10 + (i * 290)), (float)(menu_pos[1].y + 70), "ÇkÇu");
				comment->Draw((float)(menu_pos[1].x + 10 + (i * 290)), (float)(menu_pos[1].y + 140), "ÇgÇo");
				comment->Draw((float)(menu_pos[1].x + 10 + (i * 290)), (float)(menu_pos[1].y + 210), "ÇlÇo");
			...
			else if (player->c_ally[i].hp < player->c_ally[i].max_hp * 0.3)
			{
				...
				comment->Draw_Orange((float)(menu_pos[1].x + 10 + (i * 290)), (float)(menu_pos[1].y + 70), "ÇkÇu");
				comment->Draw_Orange((float)(menu_pos[1].x + 10 + (i * 290)), (float)(menu_pos[1].y + 140), "ÇgÇo");
				comment->Draw_Orange((float)(menu_pos[1].x + 10 + (i * 290)), (float)(menu_pos[1].y + 210), "ÇlÇo");
			...
			else if (player->c_ally[i].hp <= 0)
			{
				...
				comment->Draw_Red((float)(menu_pos[1].x + 10 + (i * 290)), (float)(menu_pos[1].y + 70), "ÇkÇu");
				comment->Draw_Red((float)(menu_pos[1].x + 10 + (i * 290)), (float)(menu_pos[1].y + 140), "ÇgÇo");
				comment->Draw_Red((float)(menu_pos[1].x + 10 + (i * 290)), (float)(menu_pos[1].y + 210), "ÇlÇo");
